    ...
    <footer className="bg-muted/30 pt-12 sm:pt-16 relative overflow-hidden">
      <div className="container mx-auto px-6 sm:px-4">
        <div className="max-w-4xl mx-auto mb-40 sm:mb-52">
          <div className="grid grid-cols-2 gap-10 sm:gap-16 justify-items-center text-center">
            {/* Company Column */}
        ...
        <div className="absolute bottom-0 left-0 right-0 overflow-hidden">
          ...
          <h2 
            className="text-[30vw] sm:text-[25vw] md:text-[20vw] lg:text-[15vw] font-black text-center font-heading tracking-tighter text-black/20 leading-[0.8] translate-y-[0.1em]"
            style={{
